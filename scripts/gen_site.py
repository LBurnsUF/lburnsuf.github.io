...
<section class="hero">
  <div class="reveal">
    ...
    <h1>Circuits, embedded systems, <em>and the instrumentation between them.</em></h1>
  ...
  <div class="portrait reveal"><img src="assets/img/headshot.jpg" alt="Logan Burns"></div>
</section>
...
<section class="block">
  ...
  <h2 class="sec-title">Things I've built and measured.</h2>
  <div class="cards">
    <div class="card">
...
<section class="block">
  ...
  <p style="max-width:40em; color:var(--ink-soft); margin-bottom:1.4rem">Current resume as a one-page PDF. For project detail beyond a single page, the <a href="research.html">research</a> page and <a href="https://github.com/LBurnsUF">GitHub</a> carry the depth.</p>
  <p><a class="more" style="font-family:var(--mono); border:1px solid var(--line-strong); background:var(--paper-raised); padding:0.6rem 1.1rem; display:inline-block" href="assets/doc/logan-burns-resume.pdf">DOWNLOAD RESUME (PDF) &darr;</a></p>
</section>
"""
